...
async def overdue_invoices(
    ...
    # FIX BUG 2: este endpoint hace I/O bloqueante (sleep simulando NetSuite).
    # Lo movemos a un hilo para no bloquear el event loop.
    await anyio.to_thread.run_sync(_simulated_blocking_netsuite_call)
